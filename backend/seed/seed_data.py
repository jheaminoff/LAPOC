...
PLOTS = [
    ...
    dict(
        apn="5462-001-016",
        address="2815 Sunset Blvd, Los Angeles, CA 90026",
    ...
    dict(
        apn="5423-011-023",
        address="2414 Effie St, Los Angeles, CA 90026",
        neighborhood="Silver Lake",
        zoning="R2-1VL",
        lot_size_sqft=5400,
        current_use="Single Family Residential",
    ...
    dict(
        apn="5547-026-018",
        address="1757 N Las Palmas Ave, Los Angeles, CA 90028",
    ...
    dict(
        apn="5017-026-049",
        address="3800 S Vermont Ave, Los Angeles, CA 90007",
    ...
    dict(
        apn="5006-008-016",
        address="4216 Degnan Blvd, Los Angeles, CA 90008",
    ...
    dict(
        apn="5075-003-026",
        address="1239 S Westmoreland Ave, Los Angeles, CA 90006",
    ...
    dict(
        apn="5024-018-012",
        address="3450 W 43rd St, Los Angeles, CA 90008",
        neighborhood="West Adams",
        zoning="C1.5-1-SP",
        lot_size_sqft=5800,
...
WORKFLOW_STEPS = [
    ...
    dict(
        process_type="ADU_standard",
        step_order=1,
        step_name="Choose a Standard Plan",
    ...
    dict(
        process_type="ADU_standard",
        step_order=2,
        step_name="Check Eligibility & HPOZ",
    ...
    dict(
        process_type="ADU_standard",
        step_order=4,
        step_name="Plan Check (Expedited)",
        ...
        responsible_party="LADBS",
        typical_days="10-15",
    ),
    dict(
        process_type="ADU_standard",
        step_order=5,
        step_name="Pay Issuance Fees & Receive Permit",
    ...
    dict(
        process_type="ADU",
        step_order=1,
        step_name="Check ADU Eligibility",
    ...
    dict(
        process_type="ADU",
        step_order=5,
        step_name="Respond to Corrections",
    ...
    dict(
        process_type="Bldg-New",
        step_order=1,
        step_name="Confirm Zoning & Entitlements",
    ...
    dict(
        process_type="Bldg-New",
        step_order=2,
        step_name="Prepare Construction Documents",
    ...
    dict(
        process_type="Bldg-New",
        step_order=6,
        step_name="LADOT Driveway & Access Review",
        ...
        responsible_party="LADOT",
        typical_days="14-45",
    ),
    dict(
        process_type="Bldg-New",
        step_order=7,
        step_name="PC Approved — Issue Permit",
    ...
    dict(
        process_type="Bldg-New",
        step_order=8,
        step_name="Construction & Inspections",
    ...
    dict(
        process_type="Bldg-New",
        step_order=9,
        step_name="Certificate of Occupancy",
    ...
    dict(
        process_type="Bldg-Alter/Repair",
        step_order=1,
        step_name="Determine Permit Type",
    ...
    dict(
        process_type="Bldg-Alter/Repair",
        step_order=2,
        step_name="Prepare Plans or Scope",
    ...
    dict(
        process_type="CUB",
        step_order=2,
        step_name="File CUB Application",
    ...
    dict(
        ...
        responsible_party="City Planning",
        typical_days="14-30",
    ),
    dict(
        process_type="CUB",
        step_order=4,
        step_name="Technical Review & Draft Conditions",
    ...
    dict(
        process_type="CUB",
        step_order=7,
        step_name="Letter of Determination (LOD)",
    ...
    dict(
        process_type="CUB",
        step_order=9,
        step_name="Clear Conditions at DSC",
    ...
    dict(
        process_type="CUB",
        step_order=10,
        step_name="File LADBS Building Permit",
    ...
    dict(
        process_type="ZC",
        step_order=1,
        step_name="Preliminary Zoning Assessment",
    ...
    dict(
        process_type="ZC",
        step_order=2,
        step_name="Pre-Application Conference",
    ...
    dict(
        process_type="ZC",
        step_order=3,
        step_name="File Zone Change Application",
    ...
    dict(
        process_type="ZC",
        step_order=4,
        step_name="Application Completeness",
    ...
    dict(
        process_type="ZC",
        step_order=6,
        step_name="Technical Staff Review",
    ...
    dict(
        process_type="ZC",
        step_order=7,
        step_name="Public Hearing — APC or CPC",
    ...
    dict(
        process_type="ZC",
        step_order=8,
        step_name="Council File / City Council",
    ...
    dict(
        process_type="Bldg-Addition",
        step_order=1,
        step_name="Confirm Zoning & Setbacks",
    ...
    dict(
        process_type="Bldg-Addition",
        step_order=9,
        step_name="Final Inspection & Permit Finaled",
    ...
    dict(
        process_type="Electrical",
        step_order=1,
        step_name="Determine Scope & Permit Type",
    ...
    dict(
        process_type="Fire Sprinkler",
        step_order=1,
        step_name="Prepare Sprinkler Plans",
    ...
    dict(
        process_type="Fire Sprinkler",
        step_order=6,
        step_name="Final & LAFD Witness Test",
    ...
    dict(
        process_type="Grading",
        step_order=1,
        step_name="Prepare Grading Plans",
    ...
    dict(
        process_type="Grading",
        step_order=6,
        step_name="Grading Certificate Issued",
    ...
    dict(
        process_type="Swimming-Pool/Spa",
        step_order=1,
        step_name="Verify Setbacks & Zoning",
    ...
    dict(
        process_type="Swimming-Pool/Spa",
        step_order=3,
        step_name="Submit Plans to LADBS",
    ...
    dict(
        process_type="Swimming-Pool/Spa",
        step_order=5,
        step_name="Permit Issued & Construction",
    ...
    dict(
        process_type="EIR",
        step_order=1,
        step_name="File Environmental Assessment Form",
    ...
    dict(
        process_type="EIR",
        step_order=3,
        step_name="Draft EIR Circulation",
    ...
    dict(
        process_type="EIR",
        step_order=4,
        step_name="Final EIR & Response to Comments",
    ...
    dict(
        process_type="EIR",
        step_order=5,
        step_name="EIR Certification & Findings",
    ...
    dict(
        process_type="TOC",
        step_order=1,
        step_name="Confirm TOC Eligibility",
    ...
    dict(
        process_type="TOC",
        step_order=2,
        step_name="File TOC Application",
    ...
    dict(
        process_type="TOC",
        step_order=4,
        step_name="LOD Issued — Record Affordable Housing Agreement",
    ...
    dict(
        process_type="TOC",
        step_order=5,
        step_name="Clear Conditions & File LADBS Permit",
    ...
    dict(
        process_type="ZV",
        step_order=2,
        step_name="File Variance Application",
    ...
    dict(
        process_type="ZV",
        step_order=8,
        step_name="Appeal Period & LADBS Filing",
    ...
    dict(
        process_type="ADJ",
        step_order=1,
        step_name="Confirm Adjustment Eligibility",
    ...
    dict(
        process_type="ADJ",
        step_order=2,
        step_name="File Adjustment Application",
    ...
    dict(
        process_type="ADJ",
        step_order=4,
        step_name="Technical Review & Notice",
    ...
    dict(
        process_type="PM",
        step_order=1,
        step_name="Pre-Application / Lot Tie Reversal Check",
    ...
    dict(
        process_type="PM",
        step_order=2,
        step_name="File Parcel Map Application",
    ...
    dict(
        process_type="PM",
        step_order=4,
        step_name="Conditions of Approval",
    ...
    dict(
        process_type="PM",
        step_order=6,
        step_name="Final Map Preparation",
    ...
    dict(
        process_type="PM",
        step_order=7,
        step_name="Map Recordation & New APNs",
    ...
    dict(
        process_type="SPPA",
        step_order=1,
        step_name="Confirm Specific Plan Requirements",
    ...
    dict(
        process_type="SPPA",
        step_order=2,
        step_name="File SPPA Application",
    ...
    dict(
        process_type="CDP",
        step_order=1,
        step_name="Confirm Coastal Zone Boundary",
    ...
    dict(
        process_type="CDP",
        step_order=3,
        step_name="File CDP Application",
    ...
    dict(
        process_type="CDP",
        step_order=4,
        step_name="Completeness & Technical Review",
...
WORKFLOW_PERSONAS = [
    ...
    dict(
        process_type="TOC",
        step_name="Record Affordable Housing Agreement",
        persona="developer",
    ...
    dict(
        process_type="PM",
        step_name="Conditions of Approval & Map Recordation",
        persona="developer",
    ...
    dict(
        process_type="CDP",
        step_name="Conditions & LADBS Filing",
        persona="developer",
